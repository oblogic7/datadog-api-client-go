...
func NewDistributionPointsSeries(metric string, points [][]interface{}) *DistributionPointsSeries {
	this := DistributionPointsSeries{}
	this.Metric = metric
	this.Points = points
	var type_ DistributionPointsType = DISTRIBUTIONPOINTSTYPE_DISTRIBUTION
	this.Type = &type_
	return &this
}
...
func (o *DistributionPointsSeries) GetPoints() [][]interface{} {
	if o == nil {
		var ret [][]interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DistributionPointsSeries) GetPointsOk() (*[][]interface{}, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DistributionPointsSeries) SetPoints(v [][]interface{}) {
	o.Points = v
}
